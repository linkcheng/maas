...
class SourceBase(BaseModel):
    ...
    description: Optional[str] = Field(None, description="源描述")
    type: int = Field(default=SourceType.CHAT, description="源类型")
    welcome_text: Optional[str] = Field(None, description="欢迎文本")
...
class PromptBase(BaseModel):
    ...
    extra: Optional[Dict[str, Any]] = Field(None, description="额外参数")
